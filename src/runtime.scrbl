...
@title[#:tag "getting-started"]{Acting Shooting Star}
Acting Shooting Star is a program implemented using @exec{Racket} language...
...
@subsection[#:tag "runtime-struct"]{Runtime structure}
...
@subsection[#:tag "runtime-functions"]{Runtime functions}
